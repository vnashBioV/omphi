        ...
        <div className='text-black h-screen flex gap-6 justify-center items-center flex-col'>
            {!loading ? (
                ...
                <>
                    ...
                    <p className='text-center'>Your payment was successful. You can download your source code from the link below:</p>
                    <a href={`${downloadUrl}?dl=`} download className='xl:w-[15%] flex justify-center items-center w-[70%]  h-14 text-white text-center text-[1rem] rounded-full bg-[#455CE9] hover:bg-[#455CE9]/50 transition-all duration-300'>
