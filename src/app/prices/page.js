...
const page = () => {
  return (
    <div 
        className='flex justify-between text-black h-[100%] xl:px-0 px-[1rem] flex-col xl:w-[1200px] w-full mx-auto my-[3rem] items-center'
    >
        ...
        <div className='flex w-full justify-between items-center xl:flex-row flex-col'>
            <div 
                className='xl:w-[30%] xl:mb-0 mb-6 w-full h-[500px] flex p-6 shadow-lg flex-col justify-between items-center border rounded-xl'
            >
            ...
            <div 
                className='xl:w-[30%] w-full h-[600px] flex p-6 shadow-lg flex-col justify-between text-center items-center border rounded-xl'
            >
                <h3 className='text-black text-[1.2rem]'>
                    Advanced
                </h3> 
        ...
        <div className='flex w-full items-center xl:flex-row flex-col'>
            <div 
                className='xl:w-[30%] text-center w-full h-[500px] xl:mr-16 xl:mb-0 mb-6 flex p-6 shadow-lg flex-col gap-4 items-center border rounded-xl'
            >
                <h3 className='text-black text-[1.2rem]'>
                    Basic
                </h3> 
            ...
            <div 
                className='xl:w-[30%] w-full text-center h-[500px] xl:mr-16 xl:mb-0 mb-6 flex p-6 shadow-lg flex-col gap-4 items-center border rounded-xl'
            >
                <h3 className='text-black text-[1.2rem]'>
                    Intermediate
                </h3> 
